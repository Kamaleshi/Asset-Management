...
export default function Users({ hideLayout = false }) {
  ...
  return (
    <div className={hideLayout ? "flex min-h-0 flex-1 flex-col overflow-hidden" : "flex h-screen"}>
      {!hideLayout && <Sidebar />}
      <div className="flex min-h-0 flex-1 flex-col overflow-hidden">
        <div className={hideLayout ? "flex min-h-0 flex-1 flex-col overflow-hidden" : "flex min-h-0 flex-1 flex-col overflow-hidden p-4"}>
                ...
                <table className="w-full">
                  <thead className="sticky top-0 z-10 bg-slate-100">
                    <tr>
                      ...
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Employee Name</th>
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Employee ID</th>
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Department</th>
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Business Unit</th>
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Business Head</th>
                      <th className="px-5 py-3 text-left text-xs font-semibold text-slate-700 uppercase">Assets</th>
                  ...
                  <tbody className="divide-y divide-slate-200">
                    {filteredUsers.map((user) => (
                      <tr key={user.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-5 py-3 whitespace-nowrap text-sm font-medium text-slate-800">
